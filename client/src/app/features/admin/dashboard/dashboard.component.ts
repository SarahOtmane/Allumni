...
@Component({
  ...
  template: `
    <div class="p-8 bg-[#F8FAFC] min-h-screen font-sans selection:bg-indigo-100">
      ...
      <header
        class="mb-12 relative overflow-hidden rounded-[2rem] bg-slate-900 p-10 text-white shadow-2xl shadow-slate-200"
      >
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div class="flex flex-wrap justify-center gap-3">
            <button
              ...
              class="px-6 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl text-sm font-black transition-all border border-white/10 flex items-center"
            >
            ...
            <button
              ...
              class="px-6 py-3 bg-indigo-500 hover:bg-indigo-600 rounded-2xl text-sm font-black transition-all shadow-xl shadow-indigo-500/20 flex items-center"
            >
              <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
      ...
      @if (isLoading()) {
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-[180px]">
          ...
          <div
            class="md:col-span-6 lg:col-span-4 row-span-2 bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 flex flex-col justify-between group hover:border-indigo-200 transition-all duration-500"
          >
            <div>
              <div
                class="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-500"
              >
          ...
          <div
            class="md:col-span-6 lg:col-span-4 row-span-2 bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center group hover:border-violet-200 transition-all duration-500"
          >
          ...
          <div
            class="md:col-span-3 lg:col-span-2 row-span-1 bg-emerald-50 rounded-[2rem] p-6 border border-emerald-100/50 flex flex-col justify-between group hover:scale-[1.02] transition-all"
          >
          ...
          <div
            class="md:col-span-3 lg:col-span-2 row-span-1 bg-amber-50 rounded-[2rem] p-6 border border-amber-100/50 flex flex-col justify-between group hover:scale-[1.02] transition-all"
          >
          ...
          <div
            class="md:col-span-6 lg:col-span-4 row-span-1 bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 overflow-hidden relative group"
          >
            ...
            <div class="space-y-3">
              <div class="flex items-center text-[11px] font-bold text-slate-500">
                <div
                  class="w-6 h-6 rounded-lg bg-indigo-50 text-indigo-500 flex items-center justify-center mr-3 font-black"
                >
                  S
                </div>
              ...
              <div class="flex items-center text-[11px] font-bold text-slate-500">
                <div
                  class="w-6 h-6 rounded-lg bg-violet-50 text-violet-500 flex items-center justify-center mr-3 font-black"
                >
                  L
                </div>
          ...
          <div
            class="md:col-span-6 lg:col-span-4 row-span-1 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-[2.5rem] p-8 text-white flex items-center justify-between group cursor-pointer hover:shadow-2xl hover:shadow-indigo-200 transition-all duration-500"
          >
            <div>
            ...
            <div
              class="w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center group-hover:scale-110 transition-transform"
            >
              <svg class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
