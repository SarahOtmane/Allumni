    ...
    <div class="p-6 max-w-4xl mx-auto">
      <header class="mb-8">
        ...
        <p class="mt-2 text-gray-600">
          Suivez ces étapes pour mettre à jour automatiquement les postes et expériences de vos Alumni via Apify
          (Version Gratuite).
        </p>
      </header>
      ...
      <div class="space-y-8">
        ...
        <section class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div class="flex items-center mb-4">
            <span class="bg-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3"
              >1</span
            >
          ...
          <p class="text-gray-600 ml-11">
            ...
            <span
              class="inline-flex items-center text-indigo-600 font-medium px-2 py-1 bg-indigo-50 rounded italic text-sm"
            >
              "Export Apify" </span
        ...
        <section class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div class="text-gray-600 ml-11 space-y-3">
            <p>
              ...
              <a href="https://apify.com" target="_blank" class="text-indigo-600 underline">Apify.com</a>.
            </p>
            <p>
              Dans le <strong>Store</strong>, cherchez l'Actor :
              <code class="bg-gray-100 px-1 rounded text-pink-600 font-mono">dev_fusion/linkedin-profile-scraper</code>.
            </p>
        ...
        <section class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div class="text-gray-600 ml-11 space-y-3">
            ...
            <p class="italic text-sm">
              Attendez que le statut passe à "Succeeded" (cela peut prendre quelques minutes).
            </p>
          </div>
        </section>
        ...
        <section class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p class="text-gray-600 ml-11">
            Une fois terminé, allez dans l'onglet <strong>Export</strong> (ou Dataset) sur Apify. Sélectionnez le format
            <strong>JSON</strong> et cliquez sur <strong>Download</strong>.
          </p>
        </section>
        ...
        <section class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div class="text-gray-600 ml-11 space-y-3">
            ...
            <p>
              Cliquez sur
              <span
                class="inline-flex items-center text-green-600 font-medium px-2 py-1 bg-green-50 rounded italic text-sm"
              >
                "Import Apify"
              </span>
            ...
            <p>
              <strong>C'est fini !</strong> Les postes sont à jour et vous pouvez cliquer sur
              <strong>"Détails"</strong> pour voir le parcours complet de chaque étudiant.
            </p>
          </div>
        </section>
      </div>
